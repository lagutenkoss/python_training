    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), first_name=firstname, last_name=lastname, adress=address,
                                    telephone=home, mobile=mobile, workphone=work, homeadress=phone2, e_mail=email,
                                    mailtwo=email2, mailthree=email3))
        finally:
            cursor.close()
        return list
